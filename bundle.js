...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().done(ui.success).then(ui.hideBoard).fail(ui.failure);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).done(ui.changePasswordSuccess).then(ui.showBoard).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameStatus = ['{', '"game": {', '"cell": {', '"index": 0', '"value": "x"', '},', '"over": false', '}', '}'].join('');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkDiags = function checkDiags() {
	  ...
	  // define vars
	  var topLeft = $('#cell-00').text();
	  var topRight = $('#cell-02').text();
	  var center = $('#cell-11').text();
